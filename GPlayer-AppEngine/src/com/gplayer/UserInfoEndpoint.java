...
@Api(name = "userinfoendpoint", namespace = @ApiNamespace(ownerDomain = "gplayer.com", ownerName = "gplayer.com", packagePath = ""))
public class UserInfoEndpoint
{
    ...
    public void removeUserInfo(@Named("id") Long id)
    {
        EntityManager mgr = getEntityManager();
        try
        {
    ...
    private boolean containsUserInfo(UserInfo userinfo)
    {
        ...
        {
            UserInfo item = mgr
                    .find(UserInfo.class, userinfo.getPhoneNumber());
            if (item == null)
            {
                contains = false;
            }
