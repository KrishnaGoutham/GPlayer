 ...
 * on 2014-05-18 at 14:24:41 UTC 
 * Modify at your own risk.
 */

package com.gplayer.deviceinfoendpoint;
...
public class Deviceinfoendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class GetDeviceInfo extends DeviceinfoendpointRequest<com.gplayer.deviceinfoendpoint.model.DeviceInfo> {
    ...
    protected GetDeviceInfo(java.lang.String id) {
      super(Deviceinfoendpoint.this, "GET", REST_PATH, null, com.gplayer.deviceinfoendpoint.model.DeviceInfo.class);
  ...
  /**
   * Create a request for the method "getDeviceInfoByDeviceId".
   *
   * This request holds the parameters needed by the the deviceinfoendpoint server.  After setting any
   * optional parameters, call the {@link GetDeviceInfoByDeviceId#execute()} method to invoke the
   * remote operation.
   *
   * @param id
   * @return the request
   */
  public GetDeviceInfoByDeviceId getDeviceInfoByDeviceId(java.lang.String id) throws java.io.IOException {
    GetDeviceInfoByDeviceId result = new GetDeviceInfoByDeviceId(id);
    initialize(result);
    return result;
  }

  public class GetDeviceInfoByDeviceId extends DeviceinfoendpointRequest<com.gplayer.deviceinfoendpoint.model.DeviceInfo> {
     ...
     *
     * This request holds the parameters needed by the the deviceinfoendpoint server.  After setting
     * any optional parameters, call the {@link GetDeviceInfoByDeviceId#execute()} method to invoke
     * the remote operation. <p> {@link GetDeviceInfoByDeviceId#initialize(com.google.api.client.googl
     ...
     * @since 1.13
     */
    protected GetDeviceInfoByDeviceId(java.lang.String id) {
      super(Deviceinfoendpoint.this, "GET", REST_PATH, null, com.gplayer.deviceinfoendpoint.model.DeviceInfo.class);
      this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
    }
    ...
    @Override
    public GetDeviceInfoByDeviceId setAlt(java.lang.String alt) {
      return (GetDeviceInfoByDeviceId) super.setAlt(alt);
    }

    @Override
    public GetDeviceInfoByDeviceId setFields(java.lang.String fields) {
      return (GetDeviceInfoByDeviceId) super.setFields(fields);
    }

    @Override
    public GetDeviceInfoByDeviceId setKey(java.lang.String key) {
      return (GetDeviceInfoByDeviceId) super.setKey(key);
    }

    @Override
    public GetDeviceInfoByDeviceId setOauthToken(java.lang.String oauthToken) {
      return (GetDeviceInfoByDeviceId) super.setOauthToken(oauthToken);
    }

    @Override
    public GetDeviceInfoByDeviceId setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (GetDeviceInfoByDeviceId) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public GetDeviceInfoByDeviceId setQuotaUser(java.lang.String quotaUser) {
      return (GetDeviceInfoByDeviceId) super.setQuotaUser(quotaUser);
    }

    @Override
    public GetDeviceInfoByDeviceId setUserIp(java.lang.String userIp) {
      return (GetDeviceInfoByDeviceId) super.setUserIp(userIp);
    }
    ...
    public GetDeviceInfoByDeviceId setId(java.lang.String id) {
      this.id = id;
      return this;
    }

    @Override
    public GetDeviceInfoByDeviceId set(String parameterName, Object value) {
      return (GetDeviceInfoByDeviceId) super.set(parameterName, value);
    }
  }
   ...
   * operation.
   *
   * @param content the {@link com.gplayer.deviceinfoendpoint.model.DeviceInfo}
   * @return the request
   */
  public InsertDeviceInfo insertDeviceInfo(com.gplayer.deviceinfoendpoint.model.DeviceInfo content) throws java.io.IOException {
    InsertDeviceInfo result = new InsertDeviceInfo(content);
    initialize(result);
    return result;
  }

  public class InsertDeviceInfo extends DeviceinfoendpointRequest<com.gplayer.deviceinfoendpoint.model.DeviceInfo> {
     ...
     * @since 1.13
     */
    protected InsertDeviceInfo(com.gplayer.deviceinfoendpoint.model.DeviceInfo content) {
      super(Deviceinfoendpoint.this, "POST", REST_PATH, content, com.gplayer.deviceinfoendpoint.model.DeviceInfo.class);
    }
  ...
  public class ListDeviceInfo extends DeviceinfoendpointRequest<com.gplayer.deviceinfoendpoint.model.CollectionResponseDeviceInfo> {
    ...
    protected ListDeviceInfo() {
      super(Deviceinfoendpoint.this, "GET", REST_PATH, null, com.gplayer.deviceinfoendpoint.model.CollectionResponseDeviceInfo.class);
    }
   ...
   * @return the request
   */
  public UpdateDeviceInfo updateDeviceInfo(com.gplayer.deviceinfoendpoint.model.DeviceInfo content) throws java.io.IOException {
    UpdateDeviceInfo result = new UpdateDeviceInfo(content);
    initialize(result);
    return result;
  }

  public class UpdateDeviceInfo extends DeviceinfoendpointRequest<com.gplayer.deviceinfoendpoint.model.DeviceInfo> {
     ...
     * @since 1.13
     */
    protected UpdateDeviceInfo(com.gplayer.deviceinfoendpoint.model.DeviceInfo content) {
      super(Deviceinfoendpoint.this, "PUT", REST_PATH, content, com.gplayer.deviceinfoendpoint.model.DeviceInfo.class);
    }
