...
public class Deviceinfoendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  /**
   * An accessor for creating requests from the DeviceInfoEndpoint collection.
   *
   * <p>The typical use is:</p>
   * <pre>
   *   {@code Deviceinfoendpoint deviceinfoendpoint = new Deviceinfoendpoint(...);}
   *   {@code Deviceinfoendpoint.DeviceInfoEndpoint.List request = deviceinfoendpoint.deviceInfoEndpoint().list(parameters ...)}
   * </pre>
   *
   * @return the resource collection
   */
  public DeviceInfoEndpoint deviceInfoEndpoint() {
    return new DeviceInfoEndpoint();
  }

  /**
   * The "deviceInfoEndpoint" collection of methods.
   */
  public class DeviceInfoEndpoint {

    /**
     * Create a request for the method "deviceInfoEndpoint.getDeviceInfo".
     *
